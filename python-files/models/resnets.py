...
def resnet18():
    return ResnetBuilder.build_resnet_18((3,224,224),10)
def resnet34():
    return ResnetBuilder.build_resnet_34((3,224,224),10)
def resnet101():
    return ResnetBuilder.build_resnet_101((3,224,224),10)
def resnet152():
    return ResnetBuilder.build_resnet_152((3,224,224),10)
...
def resnet_dropout(include_top=False, weights='imagenet', input_tensor = None, pooling='avg', input_shape=(224,224,3),classes=10,dp_rate=0.,n_retrain_layers=0):
